...
create database examenInsertEF7
use examenInsertEF7
...
insert into Departamento(nombreDepartamento)values('Ventas'),('RH'),('IT'),('Compras'),('Marketing')
...
insert into Empleado(nombreEmpleado,idDepartamento)values('Adrian',2),('Alan',3),('Liz',5)
