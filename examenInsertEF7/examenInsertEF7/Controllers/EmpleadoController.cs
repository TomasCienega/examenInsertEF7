using examenInsertEF7.Context;
using examenInsertEF7.Models;
using examenInsertEF7.ViewModel;
using Microsoft.AspNetCore.Mvc;
using Microsoft.EntityFrameworkCore;

namespace examenInsertEF7.Controllers
{
    public class EmpleadoController : Controller
    {
        private readonly examenInsertEF7Context _context;
        public EmpleadoController(examenInsertEF7Context context)
        {
            _context = context;
        }
